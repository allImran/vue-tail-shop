<template>
    <div class="container mx-auto shadow-md rounded relative">
        ...
        <div class="bg-white">
            ...
            <div class="ml-56 flex justify-between items-center py-3">

              <div class="flex">
                    <button class="focus:outline-none px-5 mr-2 text-white py-1 rounded bg-blue-600">dfdf</button>
                    <button class="focus:outline-none px-5 bg-gray-300 text-gray-700 py-1">fdfdfdf</button>
                </div>
          ...
          <div class="ml-56 flex py-3 md:hidden">
            <a
